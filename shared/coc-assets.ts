...
const BUILDING2_MAP: AssetMap = {
  ...
  1000034: { zh: "加农炮", en: "Builder Hall Cannon", type: "buildings2", color: "slate", icon: "💣" },
  1000035: { zh: "箭塔", en: "Builder Hall Archer Tower", type: "buildings2", color: "slate", icon: "🏹" },
  1000036: { zh: "烟花炮", en: "Builder Hall Firecrackers", type: "buildings2", color: "slate", icon: "🎆" },
  1000037: { zh: "双管加农炮", en: "Builder Hall Double Cannon", type: "buildings2", color: "slate", icon: "💣" },
  1000038: { zh: "撼地巨石", en: "Builder Hall Crusher", type: "buildings2", color: "slate", icon: "🔨" },
  1000039: { zh: "守卫岗哨", en: "Builder Hall Guard Post", type: "buildings2", color: "slate", icon: "🛡️" },
  1000040: { zh: "空中炸弹", en: "Builder Hall Air Bombs", type: "buildings2", color: "slate", icon: "💥" },
  1000041: { zh: "隐藏特斯拉", en: "Builder Hall Hidden Tesla", type: "buildings2", color: "slate", icon: "⚡" },
  1000042: { zh: "烤炉", en: "Builder Hall Roaster", type: "buildings2", color: "slate", icon: "🔥" },
  1000043: { zh: "巨型加农炮", en: "Builder Hall Giant Cannon", type: "buildings2", color: "slate", icon: "💣" },
  1000044: { zh: "超级特斯拉", en: "Builder Hall Mega Tesla", type: "buildings2", color: "slate", icon: "⚡" },
  1000045: { zh: "熔岩发射器", en: "Builder Hall Lava Launcher", type: "buildings2", color: "slate", icon: "🌋" },
  1000046: { zh: "多管迫击炮", en: "Builder Hall Multi Mortar", type: "buildings2", color: "slate", icon: "💥" },
  1000048: { zh: "X连弩", en: "Builder Hall X-Bow", type: "buildings2", color: "slate", icon: "🎯" },
  1000049: { zh: "时光钟楼", en: "Builder Hall Clock Tower", type: "buildings2", color: "slate", icon: "🕰️" },
  1000050: { zh: "战斗机器祭坛", en: "Builder Hall Battle Machine Altar", type: "buildings2", color: "slate", icon: "🛡️" },
  1000051: { zh: "宝石矿", en: "Builder Hall Gem Mine", type: "buildings2", color: "slate", icon: "💎" },
  1000052: { zh: "星空实验室", en: "Builder Hall Star Laboratory", type: "buildings2", color: "slate", icon: "🔬" },
  1000053: { zh: "储金罐", en: "Builder Hall Gold Storage", type: "buildings2", color: "slate", icon: "🏦" },
  1000054: { zh: "圣水瓶", en: "Builder Hall Elixir Storage", type: "buildings2", color: "slate", icon: "🏺" },
  1000055: { zh: "金矿", en: "Builder Hall Gold Mine", type: "buildings2", color: "slate", icon: "⛏️" },
  1000056: { zh: "圣水收集器", en: "Builder Hall Elixir Collector", type: "buildings2", color: "slate", icon: "💧" },
  1000057: { zh: "建筑工人小屋", en: "Builder Hall Builder's Hut", type: "buildings2", color: "slate", icon: "🏚️" },
  1000058: { zh: "奥仔小屋", en: "Builder Hall OTTO Hut", type: "buildings2", color: "slate", icon: "🏚️" },
  1000063: { zh: "战斗直升机祭坛", en: "Builder Hall Battle Copter Altar", type: "buildings2", color: "slate", icon: "🚁" },
  1000065: { zh: "超级皮卡祭坛", en: "Builder Hall Super P.E.K.K.A Altar", type: "buildings2", color: "slate", icon: "🤖" },
  1000078: { zh: "暗夜女巫祭坛", en: "Builder Hall Night Witch Altar", type: "buildings2", color: "slate", icon: "🧙" },
  1000080: { zh: "力量皮卡祭坛", en: "Builder Hall Power P.E.K.K.A Altar", type: "buildings2", color: "slate", icon: "🤖" },
  1000082: { zh: "野猪滑翔机祭坛", en: "Builder Hall Hog Glider Altar", type: "buildings2", color: "slate", icon: "🐗" },
};
...
// 夜世界兵种 units2 (4000xxx) — 名称核对自官方简中
const UNIT2_MAP: AssetMap = {
  ...
  4000038: { zh: "暗夜女巫", en: "Night Witch", type: "units2", color: "teal", icon: "🧙" },
